...
@Component({
  selector: "app-audit-show-product-details",
  templateUrl: "./audit-show-product-details.component.html",
  styleUrls: ["./audit-show-product-details.component.scss"],
})
export class AuditShowProductDetailsComponent
  extends BaseComponent
  implements OnInit
{
  nameModal = "auditShowProductDetailsModal";
  product: any = null;
