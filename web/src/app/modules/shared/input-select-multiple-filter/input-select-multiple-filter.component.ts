...
*/
@Component({
  selector: 'app-input-select-multiple-filter',
  templateUrl: './input-select-multiple-filter.component.html',
  styleUrls: ['./input-select-multiple-filter.component.scss']
})
export class InputSelectMultipleFilterComponent extends BaseInput {
